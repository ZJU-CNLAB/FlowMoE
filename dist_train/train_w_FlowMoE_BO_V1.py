...
def train(
    ...
    for i in range(n_bo_iter):
        ...
        pre_iteration_history.append(((time.time() - BO_start_time) / args.num_steps))
    ...
    if dist_rank == 0:
        ...
        print("pre_iteration_history:", pre_iteration_history)

    if dist_rank == 0:
        inter_func = interp1d(grad_block_size_history, pre_iteration_history, kind='cubic')
        ...
        result = gp_minimize(
            ...
            y0=pre_iteration_history.tolist(),
            n_calls=25,
